...
class ContractsDao:
    def __init__(self, table_name='taxReturns_balance'):
    ...
    def make_contract(self, contract_id):
        ...
        if contract:
            ...
            new_record = {
                "total": contract.get('total_paid') or contract.get('total'),
...
def main():
    ...
    for contract in contracts:
        ...
        i += 1  # Increment i for the next row

    workbook.save("contract_data.xlsx")
